...
// and https://www.pluralsight.com/guides/using-d3.js-inside-a-react-app

import * as rawData from './artist-genres.json';
...
export default function BarChart({
  data = DATA,
  x = (d) => d.x, // given d in data, returns the (ordinal) x-value
